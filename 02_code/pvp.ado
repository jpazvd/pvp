...
/* 1. pv: estimation with plausible values */
	...
	/* 1. Setup */
		...
		/* 1.3 load options and commands as macros */
			...
			foreach `o' in pv pv1 pv2 mdd mdd1 cmd cmdops jkzone jkrep jrr brr rw fays timss pirls pisa bs bsops jackknife jk rclass matrix weight jrrt2 parallel {
	...
	/* 2. For each plausible value, calculate estimates and VCE */
		...
		if ("`parallel'" != "") {
			...
			parallel do c:\ado\plus\p\pvp.do
